...
exports.apiContracts = {
    ...
    'notifications.inbox': endpoint({ method: 'GET', path: '/notifications/inbox', module: 'notifications', auth: true, body: noBody, params: noParams, query: notifications_1.inboxQuerySchema, response: notifications_1.inboxResponseSchema }),
    'notifications.grouped': endpoint({ method: 'GET', path: '/notifications/grouped', module: 'notifications', auth: true, body: noBody, params: noParams, query: noQuery, response: notifications_1.groupedCountsResponseSchema }),
    ...
    'notifications.bulkRead': endpoint({ method: 'PATCH', path: '/notifications/bulk-read', module: 'notifications', auth: true, body: notifications_1.bulkReadRequestSchema, params: noParams, query: noQuery, response: common_1.okSchema }),
    ...
    'notifications.archive': endpoint({ method: 'PATCH', path: '/notifications/:id/archive', module: 'notifications', auth: true, body: noBody, params: common_1.paramsIdSchema, query: noQuery, response: common_1.okSchema }),
    'notifications.unarchive': endpoint({ method: 'PATCH', path: '/notifications/:id/unarchive', module: 'notifications', auth: true, body: noBody, params: common_1.paramsIdSchema, query: noQuery, response: common_1.okSchema }),
    'notifications.preferences.get': endpoint({ method: 'GET', path: '/notifications/preferences', module: 'notifications', auth: true, body: noBody, params: noParams, query: noQuery, response: notifications_1.userNotificationPreferencesResponseSchema }),
    'notifications.preferences.channels': endpoint({ method: 'PATCH', path: '/notifications/preferences/channels', module: 'notifications', auth: true, body: notifications_1.channelPreferenceRequestSchema, params: noParams, query: noQuery, response: common_1.okSchema }),
    'notifications.preferences.quietHours': endpoint({ method: 'PATCH', path: '/notifications/preferences/quiet-hours', module: 'notifications', auth: true, body: notifications_1.quietHoursRequestSchema, params: noParams, query: noQuery, response: common_1.okSchema }),
    'notifications.preferences.digest': endpoint({ method: 'PATCH', path: '/notifications/preferences/digest', module: 'notifications', auth: true, body: notifications_1.digestSettingRequestSchema, params: noParams, query: noQuery, response: common_1.okSchema }),
    'notifications.admin.metrics': endpoint({ method: 'GET', path: '/notifications/admin/metrics', module: 'notifications', auth: true, body: noBody, params: noParams, query: noQuery, response: notifications_1.metricsSnapshotResponseSchema }),
