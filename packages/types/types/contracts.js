...
exports.apiContracts = {
    ...
    'users.list': endpoint({ method: 'GET', path: '/users', module: 'users', auth: true, body: noBody, params: noParams, query: users_1.usersQuerySchema, response: (0, common_1.paginatedSchema)(users_1.profileRowSchema) }),
    ...
    'users.bulkSetRole': endpoint({ method: 'POST', path: '/users/bulk-role', module: 'users', auth: true, body: users_1.bulkSetRoleRequestSchema, params: noParams, query: noQuery, response: users_1.bulkSetRoleResponseSchema }),
    'users.auditTrail': endpoint({ method: 'GET', path: '/users/:id/audit', module: 'users', auth: true, body: noBody, params: common_1.paramsIdSchema, query: noQuery, response: zod_1.z.array(users_1.userAuditEventSchema) }),
