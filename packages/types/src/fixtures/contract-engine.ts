...
export const contractClauseLibraryFixture: ContractClauseLibraryEntry[] = [
  {
    id: 'lib-partes',
...
export const contractTemplateFixture: ContractTemplate = {
...
export const contractVersionFixture: ContractVersionDetail = {
  ...
  clauses: contractClauseLibraryFixture,
};

/** A second, later version — drops "garantia", tweaks "pago", adds "plazo". Used by diff tests. */
export const contractVersionFixtureV2: ContractVersionDetail = {
  ...
  publishedAt: null,
  clauses: [
    contractClauseLibraryFixture[0],
    contractClauseLibraryFixture[1],
    {
      ...contractClauseLibraryFixture[2],
      bodyTemplate:
        'El precio de la transferencia será {{amount}} {{currency}}, pagadero por el Comprador mediante {{paymentMethod}} dentro de los 5 días hábiles siguientes a la aceptación.',
    },
    {
      id: 'lib-plazo',
...
export const bondFixture: BondToken = {
...
export const transferFixtureReleased: Transfer = {
  id: 'transfer-001',
...
export const transfersFixture: Transfer[] = [transferFixtureReleased];
